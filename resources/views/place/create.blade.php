...
<div class="container">
    <h1 class="mt-4">Создание места</h1>

    <form class="col-3 p-3 offset-4 border rounded" method="POST" action="{{ route('place.store') }}">
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="work" id="work-true" value="1" checked>
                <label class="form-check-label" for="work-true">Да</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="work" id="work-false" value="0">
